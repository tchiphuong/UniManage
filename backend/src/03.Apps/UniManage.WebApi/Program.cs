...
using UniManage.WebApi.Filters;
using UniManage.WebApi.Infrastructure;
using UniManage.WebApi.Middleware;
...
UniManage.Shared.Infrastructure.Utilities.ConfigHelper.Configuration = builder.Configuration;
...
// PermissionAuthorizationHandler queries SyRolePermissions table
// Cached per user for 5 minutes via Redis
// ===========================================
builder.Services.AddSingleton<IAuthorizationHandler, UniManage.WebApi.Authorization.PermissionAuthorizationHandler>();

// ===========================================
// [SECURITY] H1 ï¿½ Register IHttpClientFactory
...
UniManage.Shared.Infrastructure.Logging.UniLogManager.Initialize(builder.Configuration["AppSettings:LogPath"] ?? "logs");

// Kh?i t?o Redis Cache
UniManage.Shared.Infrastructure.Utilities.CacheHelper.Initialize(builder.Configuration);
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    options.OperationFilter<SwaggerAutoResponseFilter>();
...
// ===========================================
// [SECURITY] CORS ï¿½ Strict whitelist (C1)
...
builder.Services.AddAuthentication("Bearer")
    .AddJwtBearer("Bearer", options =>
    {
        ...
        options.Events = new Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents
        {
            ...
            {
                var logger = context.HttpContext.RequestServices.GetRequiredService<ILogger<Program>>();
                logger.LogError("OnChallenge: {Error}, {ErrorDescription}", context.Error, context.ErrorDescription);
...
if (swaggerEnabled)
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "UniManage.WebApi v1");
        options.DocumentTitle = "UniManage.WebApi Documentation";
...
// 12. CORS ï¿½ using strict policy (C1)
...
{
    Predicate = _ => false // Liveness: Ch? c?n API r?t vï¿½o endpoint nï¿½y lï¿½ tï¿½nh s?ng
});

app.MapHealthChecks("/health/ready", new Microsoft.AspNetCore.Diagnostics.HealthChecks.HealthCheckOptions
{
    Predicate = check => check.Tags.Contains("ready") // Readiness: Ph?i connect du?c DB vï¿½ Idp
});
