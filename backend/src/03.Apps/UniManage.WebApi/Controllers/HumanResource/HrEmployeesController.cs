...
using UniManage.Shared.Application.Modules.HrEmployee.Commands;
using UniManage.Shared.Application.Modules.HrEmployee.Queries;
...
public class HrEmployeesController : BaseController
{
    #region Properties

    private readonly IMediator _mediator;

    public HrEmployeesController(IMediator mediator)
    {
        _mediator = mediator;
    }
