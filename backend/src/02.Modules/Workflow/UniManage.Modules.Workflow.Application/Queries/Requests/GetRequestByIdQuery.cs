...
namespace UniManage.Modules.Workflow.Application.Queries.Requests
{
    ...
    {
        public async Task<ApiResponse<GetRequestByIdQuery.Result>> Handle(GetRequestByIdQuery request, CancellationToken cancellationToken)
        {
            ...
            using (var dbContext = new DbContext())
            {
                try
                {
                    ...
                    var result = await dbContext.QueryFirstOrDefaultAsync<GetRequestByIdQuery.Result>(sql, new { request.Id }, cancellationToken);
                    ...
                    var historySql = @"
                        ...
                        LEFT JOIN HrEmployees e ON ra.ApproverEmployeeCode = e.EmployeeCode
                        WHERE ra.RequestId = @RequestId
                        ORDER BY arl.LevelOrder";

                    var history = await dbContext.QueryAsync<GetRequestByIdQuery.ApprovalHistory>(historySql, new { RequestId = request.Id }, cancellationToken);
