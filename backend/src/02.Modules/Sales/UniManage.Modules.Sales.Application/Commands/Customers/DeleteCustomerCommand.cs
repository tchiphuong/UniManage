...
namespace UniManage.Modules.Sales.Application.Commands.Customers
{
    ...
    {
        public async Task<ApiResponse<DeleteCustomerCommand.Response>> Handle(DeleteCustomerCommand request, CancellationToken cancellationToken)
        {
            ...
            using var dbContext = new DbContext(openTransaction: true);
                    ...
                    var deletedCount = await dbContext.ExecuteAsync(sql, new { Codes = request.Codes }, cancellationToken);
