...
namespace UniManage.Modules.System.Application.Commands.User
{
    ...
    /// <summary>
    /// Lá»‡nh gÃ¡n vai trÃ² (Role) cho ngÆ°á»i dÃ¹ng
    /// </summary>
    public sealed class AssignUserRoleCommand : BaseCommand, IRequest<ApiResponse<AssignUserRoleCommand.Response>>
    {
        /// <summary>
        /// Uuid cá»§a ngÆ°á»i dÃ¹ng cáº§n Ä‘Æ°á»£c gÃ¡n vai trÃ²
        /// </summary>
        public Guid UserUuid { get; set; }

        /// <summary>
        /// MÃ£ vai trÃ² cáº§n gÃ¡n
        /// </summary>
    ...
    /// <summary>
    /// Bá»™ kiá»ƒm tra dá»¯ liá»‡u cho lá»‡nh gÃ¡n vai trÃ² ngÆ°á»i dÃ¹ng
    /// </summary>
    ...
    /// <summary>
    /// Bá»™ xá»­ lÃ½ lá»‡nh gÃ¡n vai trÃ² ngÆ°á»i dÃ¹ng
    /// </summary>
            ...
            try
            {
                using (var dbContext = new DbContext(openTransaction: true))
                {
                    try
                    {
                        ...
                        // Kiá»ƒm tra náº¿u vai trÃ² Ä‘Ã£ Ä‘Æ°á»£c gÃ¡n trÆ°á»›c Ä‘Ã³ Ä‘á»ƒ trÃ¡nh trÃ¹ng láº·p
                        ...
                        // 1. ThÃªm báº£n ghi vÃ o báº£ng mapping SyUserRoles
                        ...
                        // 2. Náº¿u ngÆ°á»i dÃ¹ng chÆ°a cÃ³ vai trÃ² máº·c Ä‘á»‹nh, gÃ¡n vai trÃ² nÃ y lÃ m máº·c Ä‘á»‹nh
