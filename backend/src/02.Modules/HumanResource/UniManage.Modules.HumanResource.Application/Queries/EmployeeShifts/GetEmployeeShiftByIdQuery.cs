...
namespace UniManage.Modules.HumanResource.Application.Queries.EmployeeShifts
{
    ...
    {
        public async Task<ApiResponse<GetEmployeeShiftByIdQuery.Result>> Handle(GetEmployeeShiftByIdQuery request, CancellationToken cancellationToken)
        {
            ...
            using (var dbContext = new DbContext())
            {
                try
                {
                    ...
                    var result = await dbContext.QueryFirstOrDefaultAsync<GetEmployeeShiftByIdQuery.Result>(sql, new { request.Id }, cancellationToken);
