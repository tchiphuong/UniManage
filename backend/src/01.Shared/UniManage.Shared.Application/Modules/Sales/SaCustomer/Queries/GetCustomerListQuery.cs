...
namespace UniManage.Shared.Application.Modules.SaCustomer.Queries
{
    ...
    {
        public async Task<ApiResponse<PagedResult<GetCustomerListQuery.Result>>> Handle(GetCustomerListQuery request, CancellationToken cancellationToken)
        {
            ...
            using (var dbContext = new DbContext())
            {
                try
                {
                    ...
                    var items = await dbContext.QueryAsync<GetCustomerListQuery.Result>(sql.ToString(), parameters, cancellationToken);
