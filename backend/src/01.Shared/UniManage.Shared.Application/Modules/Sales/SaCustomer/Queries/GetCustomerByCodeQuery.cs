...
namespace UniManage.Shared.Application.Modules.SaCustomer.Queries
{
    ...
    {
        public async Task<ApiResponse<GetCustomerByCodeQuery.Result>> Handle(GetCustomerByCodeQuery request, CancellationToken cancellationToken)
        {
            ...
            using (var dbContext = new DbContext())
            {
                try
                {
                    ...
                    var result = await dbContext.QueryFirstOrDefaultAsync<GetCustomerByCodeQuery.Result>(sql, new { request.Code }, cancellationToken);
