...
namespace UniManage.Shared.Application.Modules.SaOrder.Queries
{
    ...
    {
        public async Task<ApiResponse<PagedResult<GetOrderListQuery.Result>>> Handle(GetOrderListQuery request, CancellationToken cancellationToken)
        {
            var log = new ApiLogModel(request.HeaderInfo)
            {
                Parameter = new List<LogParamModel>
                {
                    ...
                    new LogParamModel(nameof(request.CustomerCode), request.CustomerCode),
            ...
            using (var dbContext = new DbContext())
            {
                try
                {
                    ...
                    var items = await dbContext.QueryAsync<GetOrderListQuery.Result>(sql.ToString(), parameters, cancellationToken);
