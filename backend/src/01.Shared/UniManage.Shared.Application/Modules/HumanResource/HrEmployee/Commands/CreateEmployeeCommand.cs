namespace UniManage.Shared.Application.Modules.HrEmployee.Commands
{
    ...
    /// <summary>
    /// Handler x? l� vi?c luu tr? h? so nh�n vi�n m?i v�o co s? d? li?u.
    /// </summary>
    ...
    {
        public async Task<ApiResponse<CreateEmployeeCommand.Response>> Handle(CreateEmployeeCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    // 1. Ki?m tra tr�ng m� nh�n vi�n
                    var exists = await dbContext.Set<HrEmployees>()
                    ...
                    // [LUU �]: BirthDate map v�o DateOfBirth trong Entity.
                    // Thu?c t�nh DateOfBirth trong Entity HrEmployees.
                    var entity = new HrEmployees
                    {
                    ...
                    // 3. Luu v�o Database
                    dbContext.Set<HrEmployees>().Add(entity);
