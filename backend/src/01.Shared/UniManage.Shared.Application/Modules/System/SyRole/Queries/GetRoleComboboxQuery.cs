...
namespace UniManage.Shared.Application.Modules.SyRole.Queries
{
    ...
    /// <summary>
    /// Truy v?n l?y danh s�ch vai tr� cho Combobox
    /// </summary>
    ...
    /// <summary>
    /// B? ki?m tra d? li?u cho truy v?n Combobox vai tr�
    /// </summary>
    ...
    /// <summary>
    /// B? x? l� truy v?n l?y danh s�ch vai tr� cho Combobox
    /// </summary>
    public sealed class GetRoleComboboxQueryHandler : IRequestHandler<GetRoleComboboxQuery, ApiResponse<List<ComboboxItem>>>
    {
        ...
        {
            // X�c d?nh c?t ng�n ng? d?ng (Zero Hardcode)
