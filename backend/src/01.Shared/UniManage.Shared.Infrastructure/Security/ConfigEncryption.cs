...
namespace UniManage.Shared.Infrastructure.Security;
...
public static class ConfigEncryption
{
    ...
    /// 
    /// [SECURITY] C4 ΓÇö Key management hardening:
    /// - REQUIRES UNIMANAGE_ENCRYPTION_SEED environment variable
    /// - NO hardcoded fallback ΓÇö fails fast if misconfigured
    ...
    {
        // [SECURITY] C4 ΓÇö MUST set this environment variable on each deployment
