...
{
    /// <summary>
    /// Helper class for working with SyCommons table
    /// Provides dynamic configuration values instead of hardcoded constants
    /// </summary>
    public static class CommonsHelper
    {
        /// <summary>
        /// Get a single value from SyCommons by TypeKey and ValueKey
        /// </summary>
        ...
        /// <summary>
        /// Get integer value from SyCommons (useful for status codes)
        /// </summary>
        /// <param name="typeKey">The type key - will be converted to UPPER_CASE</param>
