...
namespace UniManage.Shared.Infrastructure.Utilities
{
    ...
    public static class ValidationHelper
    {
        ...
        /// L?y d? dài t?i da c?a thu?c tính t? attribute StringLength ho?c MaxLength dùng Lambda
        /// </summary>
        /// <typeparam name="T">Entity class type / Ki?u l?p th?c th?</typeparam>
        /// <param name="propertyLambda">Lambda expression (e.g., x => x.Username)</param>
        /// <returns>Maximum length or int.MaxValue if not defined / Ð? dài t?i da ho?c int.MaxValue n?u không có d?nh nghia</returns>
        ...
        /// L?y d? dài t?i da c?a thu?c tính t? attribute StringLength ho?c MaxLength
        /// </summary>
        /// <typeparam name="T">Entity class type / Ki?u l?p th?c th?</typeparam>
        /// <param name="propertyName">Property name / Tên thu?c tính</param>
        /// <returns>Maximum length or int.MaxValue if not defined / Ð? dài t?i da ho?c int.MaxValue n?u không có d?nh nghia</returns>
