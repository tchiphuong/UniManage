...
namespace UniManage.Shared.Infrastructure.Logging
{
    ...
    public static class UniLogManager
    {
        ...
        {
            // Serialize header info thành JSON n?u có
        ...
        /// <summary>
        /// Log API request/response using ApiLogModel
        /// </summary>
        public static void WriteApiLog(ApiLogModel logData)
        {
            var apiName = logData.HeaderInfo?.ApiName ?? "Unknown";
            
            // Extract extra properties from ApiLogModel to push to Serilog Context
            ...
            using (LogContext.PushProperty("ExecutionTime", "0")) // ApiLogModel 'ms' property?
            {
