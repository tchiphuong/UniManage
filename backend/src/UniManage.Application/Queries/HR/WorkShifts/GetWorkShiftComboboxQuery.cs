...
namespace UniManage.Application.Queries.HR.WorkShifts
{
    ...
    public sealed class GetWorkShiftComboboxQuery : BaseQuery, IRequest<ApiResponse<List<ComboboxModel>>>
    {
    ...
    public sealed class GetWorkShiftComboboxQueryHandler : IRequestHandler<GetWorkShiftComboboxQuery, ApiResponse<List<ComboboxModel>>>
    {
        public async Task<ApiResponse<List<ComboboxModel>>> Handle(GetWorkShiftComboboxQuery request, CancellationToken ct)
        {
            ...
            try
            {
                using (var db = new DbContext())
                {
                    ...
                    var items = workShifts.Select(ws => new ComboboxModel
                    {
                        Code = ws.Code,
