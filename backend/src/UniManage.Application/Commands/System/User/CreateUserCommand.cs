...
{
    #region Command
    public class CreateUserCommand : CoreBaseCommand, IRequest<CoreResponse>
	{
	}
    #endregion
    ...
    #region Handler
    public class CreateUserCommandHandler : IRequestHandler<CreateUserCommand, CoreResponse>
	{
		public async Task<CoreResponse> Handle(CreateUserCommand request, CancellationToken cancellationToken)
		{
