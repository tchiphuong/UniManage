...
{
    #region Command
    public class UpdateUnitCommand : BaseCommand, IRequest<ApiResponse<object>>
	{
    ...
    #region Handler
    public class UpdateUnitCommandHandler : IRequestHandler<UpdateUnitCommand, ApiResponse<object>>
	{
