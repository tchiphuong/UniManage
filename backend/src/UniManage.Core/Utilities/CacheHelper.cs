...
namespace UniManage.Core.Utilities
{
    ...
    public static class CacheHelper
    {
        ...
        private static int _defaultTTLMinutes = Core.Constant.CacheTimeConstant.Normal;
        ...
        public static void Initialize(IConfiguration config)
        {
            try
            {
                ...
                _defaultTTLMinutes = redisConfig.GetValue<int>("DefaultTTLMinutes", Core.Constant.CacheTimeConstant.Normal);
