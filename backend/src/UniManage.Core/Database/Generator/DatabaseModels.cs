...
namespace UniManage.Core.Models.Entities
{
    ...
    public class sy_languages
    {
        ...
        public int Id { get; set; }
        /// <summary>
        /// M� ng�n ng? theo chu?n ISO (v� d?: en, vi, zh-CN)
        /// </summary>
        [Required]
        [StringLength(10)]
        public string LanguageCode { get; set; }
        /// <summary>
        /// T�n d?y d? c?a ng�n ng?
        /// </summary>
        [Required]
        [StringLength(100)]
        public string LanguageName { get; set; }
        /// <summary>
        /// Bi?u tu?ng ng�n ng? (emoji ho?c URL ?nh)
        /// </summary>
        [StringLength(100)]
        public string Icon { get; set; }
        /// <summary>
        /// Ng�n ng? m?c d?nh c?a h? th?ng (1 = c�, 0 = kh�ng)
        /// </summary>
        [Required]
        [Column(TypeName = "bit")]
        public bool IsDefault { get; set; }
        /// <summary>
        /// Tr?ng th�i ng�n ng?: 1 = dang d�ng, 0 = kh�ng d�ng
        /// </summary>
        [Required]
        [Column(TypeName = "bit")]
        public bool IsActive { get; set; }
