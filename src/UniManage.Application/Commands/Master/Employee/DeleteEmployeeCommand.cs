...
{
	#region Command
	public class DeleteEmployeeCommand : CoreBaseCommand, IRequest<CoreResponse>
	{
    ...
    #region Handler
    public class DeleteEmployeeCommandHandler : IRequestHandler<DeleteEmployeeCommand, CoreResponse>
	{
		public async Task<CoreResponse> Handle(DeleteEmployeeCommand request, CancellationToken cancellationToken)
		{
